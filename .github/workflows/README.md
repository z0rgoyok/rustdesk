...
CI/CD-рецепты управляемого fork RustDesk. Workflow выпускает проверяемые
Windows x64 и macOS arm64 варианты Share Desk X Plus из закреплённого дерева.
...
| [flutter-build.yml](./flutter-build.yml) | Собирает управляемые Windows x64 EXE/MSI или macOS arm64 DMG; фиксирует имя, endpoint, публичный ключ и platform identity, создаёт SHA-256, attestations, artifacts и prerelease. | 506e72d129a9f400e3e4f2c14289392449302e8f |
