...
| [flutter-build.yml](./flutter-build.yml) | Собирает Windows x64 portable EXE и MSI; после checkout детерминированно задаёт имя Share Desk X Plus, `share-desk-x-plus.tich.app` и публичный ключ, создаёт SHA-256, attestations, Actions artifact и prerelease. | f267fdc6ce0324343bf69625fc0506185d72f214 |
