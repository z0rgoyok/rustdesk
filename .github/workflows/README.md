...
| [flutter-build.yml](./flutter-build.yml) | Собирает Windows x64 portable EXE и MSI; после checkout детерминированно задаёт имя Share Desk X Plus, `share-desk-x-plus.tich.app` и публичный ключ, создаёт SHA-256, attestations, Actions artifact и prerelease. | 835504b60e5d93ab8fe3a6fcbc4eb3e4c6f67ca6 |
